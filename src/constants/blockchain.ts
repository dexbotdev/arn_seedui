...
export const DEFAULD_NETWORK = Networks.AETHT;

export const AVAILABLE_CHAINS = [Networks.AETH, Networks.AETHT];
export const WMEMO_BRIDG_CHAINS = [Networks.AETHT, Networks.AETH];
export const BALANCE_CHAINS = [Networks.AETH, Networks.AETHT];
